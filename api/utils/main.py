...
from api.services.admin import AdminDashboard, AdminArcade, AdminArcadeOwner, AdminArcadeMachine, AdminArcades, OnboardArcade, Maintenance, Client, AdminUsers, News
...
api.add_resource(News, '/v1/admin/news')
